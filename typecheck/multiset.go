...
// func slowMultisetSort(a *typeMultiset) {
// 	n := len(a.names)
// 	idx := make([]int, n)
...
// 		if a.names[i] == a.names[j] {
// 			if a.kinds[i] < a.kinds[j] {
// 				return -1
// 			} else if a.kinds[i] > a.kinds[j] {
// 				return 1
// 			}
// 			return 0
// 		}

// 		if a.names[i].Value() < a.names[j].Value() {
// 			return -1
// 		} else if a.names[i].Value() > a.names[j].Value() {
// 			return 1
// 		}
...
// 	tmpNames := make([]unique.Handle[string], n)
// 	tmpKinds := make([]parser.NodeKind, n)
// 	tmpOffsets := make([]uint32, n)
// 	tmpUnits := make([]*Unit, n)

// 	for i := 0; i < n; i++ {
// 		tmpNames[i] = a.names[idx[i]]
// 		tmpKinds[i] = a.kinds[idx[i]]
// 		tmpOffsets[i] = a.offsets[idx[i]]
// 		tmpUnits[i] = a.units[idx[i]]
// 	}

// 	a.names = tmpNames
// 	a.kinds = tmpKinds
// 	a.offsets = tmpOffsets
// 	a.units = tmpUnits
// }
